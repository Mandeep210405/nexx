...
<head>
    ...
    $admin_root = (strpos($_SERVER['PHP_SELF'], '/admin/subjects/') !== false ||
                  strpos($_SERVER['PHP_SELF'], '/admin/users/') !== false)
                  ? '../' : '';
    ?>
    <link href="<?php echo $admin_root; ?>assets/css/admin-style.css" rel="stylesheet">
...
<body>
    <header class="navbar navbar-dark sticky-top flex-md-nowrap p-0 shadow">
        <div class="container-fluid">
            <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3" href="<?php echo $admin_root; ?>index.php">NEXX Admin</a>
