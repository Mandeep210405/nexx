                    ...
                    <div id="questionsList">
                        ...
                        <div class="question-item border rounded p-3 mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" name="questions[0][code_lang]" required>
...
function addQuestionField() {
    ...
    newQuestion.innerHTML = `
        ...
        <div class="mb-3">
            <label class="form-label">Code Language</label>
            <select class="form-select" name="questions[${questionCounter}][code_lang]" required>
                <option value="">Select Language</option>
                <option value="cpp">C++</option>
                <option value="c">C</option>
                <option value="java">Java</option>
            ...
            if (data.success) {
                ...
                data.practical.questions.forEach((question, index) => {
                    ...
                    questionDiv.innerHTML = `
                        ...
                        <div class="mb-3">
                            <label class="form-label">Code Language</label>
                            <select class="form-select" name="questions[${index}][code_lang]" required>
                                <option value="">Select Language</option>
                                <option value="cpp" ${question.code_lang === 'cpp' ? 'selected' : ''}>C++</option>
                                <option value="c" ${question.code_lang === 'c' ? 'selected' : ''}>C</option>
                                <option value="java" ${question.code_lang === 'java' ? 'selected' : ''}>Java</option>
                                <option value="python" ${question.code_lang === 'python' ? 'selected' : ''}>Python</option>
                                <option value="javascript" ${question.code_lang === 'javascript' ? 'selected' : ''}>JavaScript</option>
                                <option value="php" ${question.code_lang === 'php' ? 'selected' : ''}>PHP</option>
                                <option value="sql" ${question.code_lang === 'sql' ? 'selected' : ''}>SQL</option>
                                <option value="html" ${question.code_lang === 'html' ? 'selected' : ''}>HTML</option>
                                <option value="css" ${question.code_lang === 'css' ? 'selected' : ''}>CSS</option>
                            </select>
                        </div>
                        <button type="button" class="btn btn-danger btn-sm" onclick="this.parentElement.remove()">
                            <i class="fas fa-trash me-2"></i>Remove Question
...
function addEditQuestionField() {
    ...
    newQuestion.innerHTML = `
        ...
        <div class="mb-3">
            <label class="form-label">Code Language</label>
            <select class="form-select" name="questions[${editQuestionCounter}][code_lang]" required>
                <option value="">Select Language</option>
                <option value="cpp">C++</option>
                <option value="c">C</option>
                <option value="java">Java</option>
